...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-V7M6L4KC.js";
import {
  Button_default,
  Button_default2
} from "./chunk-YPT3D5WH.js";
import {
  Col_default,
  ...
  map,
  useCol
} from "./chunk-6MEVV6ML.js";
import "./chunk-KBUAZBQ3.js";
import {
  require_warning
} from "./chunk-QYBL3KOE.js";
import {
...
import {
  ...
  useMounted
} from "./chunk-HWAJP5Y2.js";
import {
  createWithBsPrefix,
  require_prop_types
} from "./chunk-MC2YPJI3.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-UE7E6ZGR.js";
import {
  require_jsx_runtime
} from "./chunk-6DVFAGPN.js";
import {
  hasClass
} from "./chunk-L4R2WAMN.js";
import {
  require_react_dom
} from "./chunk-CLG3GC23.js";
import "./chunk-XD5OPDCR.js";
import "./chunk-OKP7AEIH.js";
import {
  __commonJS,
  __toESM,
  require_react
...
function useTimeout() {
  ...
  var handleRef = (0, import_react9.useRef)();
...
var InputGroup = React25.forwardRef(({
  ...
  return (0, import_jsx_runtime25.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime25.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames22.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var TabContext = React26.createContext(null);
...
var NavItem = React27.forwardRef((_ref, ref) => {
  let {
  ...
  return (0, import_jsx_runtime26.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React28.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  const needsRefocusRef = (0, import_react13.useRef)(false);
  ...
  const listNode = (0, import_react13.useRef)(null);
  ...
  return (0, import_jsx_runtime27.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime27.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime27.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
function useMediaQuery(query, targetWindow) {
  ...
  var _useState = (0, import_react17.useState)(function() {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react18.useMemo)(function() {
...
var OffcanvasToggling = React36.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime35.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React36.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React37.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime37.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React38.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime37.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime39.jsxs)(import_jsx_runtime38.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime37.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React39.forwardRef((props, ref) => {
  const context4 = (0, import_react20.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime40.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React40.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  return (0, import_jsx_runtime41.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React41.forwardRef(({
  ...
  return (0, import_jsx_runtime43.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames33.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime42.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime42.jsx)(Dropdown_default.Menu, {
      role: menuRole,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime49.jsxs)(import_jsx_runtime48.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react26.cloneElement)(children, triggerProps), (0, import_jsx_runtime47.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Spinner = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames42.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime69.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
