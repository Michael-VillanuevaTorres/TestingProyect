...
def get_product():
    id_product = request.args.get('id_product')
    product = db.producto.query.get_or_404(id_product)
    product_json = {}
...
def get_product_developers():
    ...
    desarrolladores = db.desarrollador_producto.query.filter_by(id_producto=id_product).all()
    ...
    for dp in desarrolladores:
        ...
        developer = db.desarrollador.query.get_or_404(id_desarollador)
        developer_json = {}
